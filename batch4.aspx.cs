...
public partial class batch4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            CommFun.BindDropDownListWithStaticNumbers(ref ddlyear, 2014, 2017, 1, "Select year");
            this.BindListView();
        }
    ...
    private void BindListView()
    {
        ...
        SqlCommand cmd = new SqlCommand();
                ...
                {
                    SqlDataSource1.SelectCommand = "select * from alumnidetails where batch between 2014 and 2017 order by name";
                }
