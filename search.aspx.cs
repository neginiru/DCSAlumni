...
public partial class search : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            CommFun.BindDropDownListWithStaticNumbers(ref ddlyear, 1991, 2000, 1, "Select year");
            this.BindListView();
    ...
    private void BindListView()
    {
        ...
        {
            SqlDataSource1.SelectCommand = "select * from alumnidetails where batch between 1992 and 2000 order by name";
        }
