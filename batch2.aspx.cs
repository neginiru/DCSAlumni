...

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            CommFun.BindDropDownListWithStaticNumbers(ref ddlyear, 2001, 2006, 1, "select year");
            this.BindListView();
...
private void BindListView()
    {
        SqlConnection con = new SqlConnection(constr);
            ...
            {
                SqlDataSource1.SelectCommand = "select * from alumnidetails where batch between 2001 and 2006 order by name";
            }
